...
export default function ProfilePage() {
  ...
  const [profile, setProfile] = useState({
    name: "Mark Maged",
    email: "mark.maged@student.guc.edu.eg",
  ...
  const [isProfileViewsModalOpen, setIsProfileViewsModalOpen] = useState(false);
  ...
  return (
    <div className="space-y-8">
      {/* Notification Toast */}
      {notificationVisible && (
        <div className="fixed top-4 right-4 z-50 bg-black border border-green-500/30 rounded-lg shadow-lg p-4 max-w-md animate-in slide-in-from-right">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <Button
          onClick={() => setIsProfileViewsModalOpen(true)}
          variant="outline"
          className="bg-black border-gray-800 text-white hover:bg-gray-900"
        >
          <Eye className="h-4 w-4 mr-2" />
          Profile Views ({companyViews.length})
        </Button>
      </div>
      ...
      {/* Profile Views Modal */}
      <Dialog
        open={isProfileViewsModalOpen}
        onOpenChange={setIsProfileViewsModalOpen}
      >
        <DialogContent className="bg-black border-gray-800 text-white max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              These companies have viewed your pro-student profile in the last
              30 days
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4">
            <div className="space-y-4">
              {companyViews.map((company) => (
                <div
                  key={company.id}
                  className="p-4 border border-gray-800 rounded-lg hover:border-gray-700 transition-all"
                >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center text-sm text-gray-400 mt-1">
                          ...
                          <span>
                            Viewed on{" "}
                            {new Date(company.viewDate).toLocaleDateString()}
                          </span>
                          {company.hasOpenPositions && (
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            showNotification(
                              ...
                              `Your contact request has been sent to ${company.companyName}`
                            );
                          }}
                        >
                          Contact Company
          ...
          <DialogFooter>
            <Button
              onClick={() => setIsProfileViewsModalOpen(false)}
              variant="outline"
