              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 transform translate-y-full bg-orange group-hover:translate-y-0 ease">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                    ...
                    <span className="absolute inset-0 flex items-center justify-center w-full h-full font-bold text-white transition-transform duration-300 transform group-hover:-translate-y-full ease whitespace-nowrap">
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex items-center justify-between bg-black p-3 rounded-lg border border-gray-800">
                            ...
                            <Button
                              variant="outline"
                              className="border-gray-700 text-white hover:bg-black hover:text-white bg-[#FF6F1B]/25 hover:cursor-pointer"
                            >
                              View
                            </Button>
                          </div>
                        ...
                        <div className="border-t border-gray-800 pt-6 flex justify-between items-center">
                          ...
                          {selectedApplication.status === "pending" && (
                            <div className="flex gap-3">
                              <Button
                                className="bg-black text-white hover:text-white border hover:bg-[#FF6F1B]/25  border-gray-800 hover:cursor-pointer "
                                onClick={() =>
                              ...
                              <Button
                                className="bg-gradient-to-r from-[#EC1024] to-[#FF6F1B] text-white hover:scale-105 hover:cursor-pointer hover:opacity-90"
                                onClick={() =>
                                  updateApplicationStatus(
                                    selectedApplication.id,
                                    "accepted"
                              ...
                              <Button
                                className="bg-black text-[#EC1024] hover:cursor-pointer hover:bg-black border border-gray-800"
                                onClick={() =>
                                  updateApplicationStatus(
                                    selectedApplication.id,
                                    "rejected"
                          ...
                          {selectedApplication.status === "interviewing" && (
                            <div className="flex gap-3">
                              <Button
                                className="bg-gradient-to-r from-[#EC1024] to-[#FF6F1B] hover:scale-105 text-white hover:cursor-pointer"
                                onClick={() =>
                                  updateApplicationStatus(
                                    selectedApplication.id,
                                    "accepted"
                              ...
                              <Button
                                className="bg-black text-[#EC1024] hover:bg-black hover:cursor-pointer border border-gray-800"
                                onClick={() =>
                                  updateApplicationStatus(
                                    selectedApplication.id,
                                    "rejected"
                          ...
                          {selectedApplication.status === "accepted" && (
                            <div className="flex gap-3">
                              <Button
                                className="bg-gradient-to-r from-[#EC1024] to-[#FF6F1B] hover:cursor-pointer hover:scale-105 text-white hover:opacity-90"
                                onClick={() =>
                                  updateApplicationStatus(
                                    selectedApplication.id,
                                    "finalized"
                              ...
                              <Button
                                className="bg-black text-[#EC1024] hover:bg-black border hover:cursor-pointer  border-gray-800"
                                onClick={() =>
                                  updateApplicationStatus(
                                    selectedApplication.id,
                                    "rejected"
                    ...
                    {companyDocuments.map((doc) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <Button
                            variant="outline"
                            className="border-grey-700 hover:cursor-pointer bg-black text-white  h-8 w-8 p-0"
                          >
